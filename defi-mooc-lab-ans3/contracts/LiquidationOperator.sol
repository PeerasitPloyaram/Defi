...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    IUniswapV2Pair immutable uniswapV2Pair_USDC_WETH; // Pool1
    ...
    constructor() {
        ...
        uniswapV2Pair_USDC_WETH = IUniswapV2Pair(uniswapV2Factory.getPair(address(USDC), address(WETH))); // Pool1
    ...
    function uniswapV2Call(
        ...
        (uint256 reserve_USDC_Pool1, uint256 reserve_WETH_Pool1, ) = uniswapV2Pair_USDC_WETH.getReserves(); // Pool1
        //(uint256 reserve_WETH_Pool2, uint256 reserve_USDT_Pool2, ) = uniswapV2Pair_WETH_USDT.getReserves(); // Pool2
        //console.log("2.0");
